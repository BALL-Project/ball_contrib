...
IF(MSVC) # Windows
	...
	IF(MSVC10)
		SET(BUILDDIR "${CONTRIB_BINARY_SRC}/${PACKAGE_NAME}/build/vs2010")
	ENDIF()
...
ExternalProject_Add(${PACKAGE_NAME}
	...
	INSTALL_COMMAND "${CMAKE_COMMAND}" -Dconfig=${CMAKE_CFG_INTDIR} -P "${CONTRIB_BINARY_SRC}/tbb_install.cmake"
)
